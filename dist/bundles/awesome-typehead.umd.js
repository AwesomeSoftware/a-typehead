(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('rxjs/Observable'), require('rxjs/Subject'), require('rxjs/add/observable/of'), require('rxjs/add/operator/switchMap'), require('rxjs/add/operator/debounceTime'), require('rxjs/add/operator/distinctUntilChanged')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', 'rxjs/Observable', 'rxjs/Subject', 'rxjs/add/observable/of', 'rxjs/add/operator/switchMap', 'rxjs/add/operator/debounceTime', 'rxjs/add/operator/distinctUntilChanged'], factory) :
	(factory((global['awesome-typehead'] = {}),global.ng.core,global.ng.common,global.ng.forms,global.Rx,global.Rx));
}(this, (function (exports,core,common,forms,Observable,Subject) { 'use strict';
...
var AwesomeOptionsComponent = (function () {
    ...
    function AwesomeOptionsComponent(optionsElement) {
        ...
        this.onOptionSelected = new core.EventEmitter();
        this.onMouseEnter = new core.EventEmitter();
        this.onHelperButtonClick = new core.EventEmitter();
    }
...
AwesomeOptionsComponent.propDecorators = {
    ...
    'mainElement': [{ type: core.Input },],
    'debug': [{ type: core.Input },],
    'style': [{ type: core.Input },],
    'activeFocusPosition': [{ type: core.Input },],
    'helperButton': [{ type: core.Input },],
    'onOptionSelected': [{ type: core.Output },],
    'onMouseEnter': [{ type: core.Output },],
    'onHelperButtonClick': [{ type: core.Output },],
};
...
var AwesomeTypeheadComponent = (function () {
    ...
    function AwesomeTypeheadComponent(container, optionsElement, componentFactoryResolver, viewContainerRef) {
        ...
        this.optionsFilterTerms = new Subject.Subject();
    ...
    AwesomeTypeheadComponent.prototype.ngOnInit = function () {
        ...
        if (this.filterOnBackend) {
            ...
            this.optionsFilterObservable = this.optionsFilterTerms
                ...
                return Observable.Observable.of(_this.filterOptions(term, _this.optionsUnFiltered));
            });
...
AwesomeTypeheadComponent.decorators = [
    { type: core.Component, args: [{
                ...
                providers: [{
                        ...
                        useExisting: core.forwardRef(function () { return AwesomeTypeheadComponent; }),
                        multi: true
                    }],
...
AwesomeTypeheadComponent.propDecorators = {
    ...
    'options': [{ type: core.Input },],
    'selectedOption': [{ type: core.Input },],
    'optionsOpened': [{ type: core.Input },],
    'filterOnBackend': [{ type: core.Input },],
    'filterDelayMs': [{ type: core.Input },],
    'helperButton': [{ type: core.Input },],
    'onHelperButtonClick': [{ type: core.Output },],
    'onOptionSelected': [{ type: core.Output },],
};
...
AwesomeTypeheadMultipleComponent.decorators = [
    { type: core.Component, args: [{
                ...
                providers: [{
                        provide: forms.NG_VALUE_ACCESSOR,
                        useExisting: core.forwardRef(function () { return AwesomeTypeheadMultipleComponent; }),
                        multi: true
                    }],
...
exports.AwesomeTypeheadModule = AwesomeTypeheadModule;
exports.ɵc = AwesomeOptionsComponent;
exports.ɵb = AwesomeTypeheadMultipleComponent;
exports.ɵa = AwesomeTypeheadComponent;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=awesome-typehead.umd.js.map
